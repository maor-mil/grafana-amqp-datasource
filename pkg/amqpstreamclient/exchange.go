...
type Exchange interface {
	CreateExchange(*AmqpStreamOptions) error
}
...
func (exchangeOptions *ExchangeOptions) CreateExchange(options *AmqpStreamOptions) error {
	...
	return err // failOnError(err, fmt.Sprintf("Failed to create the exchange %s", exchangeOptions.Name))
}
